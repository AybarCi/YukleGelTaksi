...
Backend sunucusu `http://192.168.1.173:3000` adresinde çalışmaktadır.
...
```
GET http://192.168.1.173:3000/api/drivers
```

### Sürücü Kaydet
```
POST http://192.168.1.173:3000/api/drivers/register
Content-Type: application/json
