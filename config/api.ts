...
export const API_CONFIG = {
  BASE_URL: 'http://192.168.1.137:3000',
  FILES_URL: 'http://192.168.1.137:3000/api/files',
...
if (process.env.NODE_ENV === 'development') {
  ...
  API_CONFIG.BASE_URL = 'http://192.168.1.137:3000';
  API_CONFIG.FILES_URL = 'http://192.168.1.137:3000/api/files';
