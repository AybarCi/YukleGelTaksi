...
export const API_CONFIG = {
  BASE_URL: 'http://192.168.1.106:3001',
  FILES_URL: 'http://192.168.1.106:3001/api/files',
...
if (process.env.NODE_ENV === 'development') {
  ...
  API_CONFIG.BASE_URL = 'http://192.168.1.106:3001';
  API_CONFIG.FILES_URL = 'http://192.168.1.106:3001/api/files';
